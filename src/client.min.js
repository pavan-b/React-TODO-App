...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tabular = __webpack_require__(169);

	var _tabular2 = _interopRequireDefault(_tabular);

	var _storeApi = __webpack_require__(171);
	...
	var Title = function (_React$Component) {
		...
		_createClass(Title, [{
			...
			key: "deleteFromState",
			value: function deleteFromState(id) {
			...
			key: "editFromState",
			value: function editFromState(id) {
				this.idToEdit = id;
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						"div",
						{ className: "row" },
						_react2.default.createElement(_content2.default, _extends({ addToState: this.addToState.bind(this) }, this.state, { show: this.updateIt.bind(this), idToEdit: this.idToEdit })),
						_react2.default.createElement(_tabular2.default, { contents: this.state.data, deleteFromState: this.deleteFromState.bind(this), editFromState: this.editFromState.bind(this) })
					)
				);
			}
		}]);
	...
	var Content = function (_React$Component) {
	  ...
	  _createClass(Content, [{
	    ...
	    value: function componentWillReceiveProps(newProps) {
	      ...
	      if (isEdit) {
	        (function () {
	          _this2.isEdit = isEdit;
	          var data = newProps.data;
	          var idToEdit = newProps.idToEdit;

	          data.map(function (obj) {

	            if (obj.id.toString() === idToEdit.toString()) {
	              _this2.data = obj;
	              _this2.refs.id.value = obj.name;
	              _this2.refs.phone.value = obj.phone;
	              _this2.refs.city.value = obj.city;
	            }
	          });
	        })();
	      }
	    ...
	    value: function handleEdit() {
	      ...
	      changedValue.phone = this.refs.phone.value;
	      changedValue.city = this.refs.city.value;
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'col-xs-2' },
	          _react2.default.createElement('input', { type: 'text', placeholder: 'Enter name', className: 'form-control', ref: 'id' }),
	          _react2.default.createElement('input', { type: 'text', placeholder: 'Enter phone no', className: 'form-control', ref: 'phone' }),
	          _react2.default.createElement('input', { type: 'text', placeholder: 'Enter city', className: 'form-control', ref: 'city' }),
	          _react2.default.createElement(
	            'button',
	            { className: this.isEdit ? 'btn btn-info' : 'btn btn-success', onClick: this.isEdit ? this.handleEdit.bind(this) : this.handleChange.bind(this) },
	            ' ',
	            btnValue
	          )
	        )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tabular = function (_React$Component) {
		_inherits(Tabular, _React$Component);

		function Tabular() {
			_classCallCheck(this, Tabular);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Tabular).call(this));
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							"tbody",
							null,
							contents.map(function (d) {

								return _react2.default.createElement(_table2.default, { key: d.id, print: d, "delete": _this2.delete, edit: _this2.props.editFromState });
							})
						)
					)
				);
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'button',
	            { className: 'btn btn-danger', value: print.id, onClick: this.handleDelete },
	            'delete'
	          ),
	          '  ',
	          _react2.default.createElement(
	            'button',
	            { className: 'btn btn-info', value: print.id, onClick: this.handleEdit },
	            'edit'
	          )
	        )
	      );
